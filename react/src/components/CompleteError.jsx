...
function CompleteError() {
  ...
  return (
    <div className="checkout-container-complete sentry-unmask">
      ...
      <p>
        We were unable to process your order but will do everything we can to make it right. Please{" "}
        <Link to="#">reach out to us</Link> if you have been charged or have any questions.
      </p>
